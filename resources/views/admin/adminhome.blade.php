<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-3xl text-black-800 dark:text-black-200 leading-tight">
            Welcome to Your Dashboard as Admin
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Admin Dashboard Overview</h2>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="bg-green-100 dark:bg-green-800 p-6 rounded-lg shadow-md">
                            ...
                            <p class="text-sm text-green-600 dark:text-green-300">$89,50,000</p>
                        </div>
                        <!-- Card 3 -->
                        <div class="bg-yellow-100 dark:bg-yellow-800 p-6 rounded-lg shadow-md">
                            ...
                            <p class="text-sm text-yellow-600 dark:text-yellow-300">Total Orders: 5000</p>
                        </div>
                        <!-- Card 4 -->
                        <div class="bg-pink-100 dark:bg-pink-800 p-6 rounded-lg shadow-md">
                            ...
                            <p class="text-sm text-pink-600 dark:text-pink-300">New Feedback: 810</p>
                        </div>
                    </div>
                </div>
            </div>
